  ...
  return (
    <section className="relative py-20 md:py-32 px-6 overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto text-center">
        <h2 className="text-4xl sm:text-5xl font-bold text-white tracking-tighter mb-4 leading-tight">
          End the
          <br />
          Alt-Tab Hell.
        </h2>
        <p className="text-slate-400 text-base mb-8 md:mb-12">
          Join the early access list. Be the first to create and share Via workflows.
        </p>

        {/* Command-line style input */}
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 bg-slate-900/70 backdrop-blur-xl border border-white/10 rounded-2xl px-5 py-3.5 shadow-[0_0_40px_rgba(0,0,0,0.4)] focus-within:border-indigo-500/40 focus-within:shadow-[0_0_40px_rgba(99,102,241,0.1)] transition-all">
            <span className="hidden sm:inline text-indigo-400 font-mono text-sm select-none">$</span>
            <input
              type="email"
              value={email}
            ...
            <button
              type="submit"
              className="bg-indigo-500 hover:bg-indigo-400 text-white rounded-xl px-5 py-2.5 sm:py-2 text-sm font-semibold transition-all shadow-[0_0_16px_rgba(99,102,241,0.35)] hover:shadow-[0_0_24px_rgba(99,102,241,0.5)] whitespace-nowrap"
            >
              Get Early Access
            </button>
          </div>
